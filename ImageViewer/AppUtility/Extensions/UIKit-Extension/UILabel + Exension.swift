...
extension UILabel {
    ...
    func setAttributedStrings(attributedStrings: [String], textColors: [UIColor], fonts: [UIFont], lineSpacing: CGFloat? = 5, alignment: NSTextAlignment = .natural, isUnderline: Bool = false, isStrikeThough: Bool = false) {
        self.attributedText = self.text?.setAttributedStrings(attributedStrings: attributedStrings, textColors: textColors, fonts: fonts, lineSpacing: lineSpacing, alignment: alignment, isUnderline: isUnderline, isStrikeThough: isStrikeThough)
    }
