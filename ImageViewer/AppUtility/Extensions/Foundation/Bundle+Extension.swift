...
extension Bundle {
    ...
    func getBundleName() -> Bundle {
        if let languageArray = UserDefaults.standard.value(forKey: UserDefaults.Keys.appleLanguages) as? [String],
           let languageObj = languageArray.first,
           let language = AppLanguages(rawValue: String(languageObj.prefix(2))),
        ...
        return Bundle.main  // last resort
    }
